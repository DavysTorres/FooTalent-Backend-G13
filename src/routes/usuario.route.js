...
const { cargarImagen, upload, uploadFile } = require('../services/cargarArchivo.service');
...
//Edita un usuario
router.put('/editar/:id', uploadFile, usuarioController.editarUsuario);
...
router.get('/verifyAccount', usuarioController.verificarCuenta);
